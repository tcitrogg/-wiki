...
<!-- <div class={`w-full h-full px-4 leading-4 text-zinc-700 dark:text-zinc-200
  prose
...
<div class="w-full h-full px-4 leading-4
  prose
  ...
  prose-code:p-1 prose-code:mx-0.5 prose-code:rounded-lg prose-code:bg-zinc-200 dark:prose-code:bg-zinc-800 md:prose-code:bg-zinc-300 md:dark:prose-code:bg-zinc-900 prose-code:dark:text-zinc-200
