...
<main class="w-full h-full flex flex-col p-4 rounded-md">
  <div class="w-full lg:w-10/12 lg:mx-auto h-full space-y-4">
    ...
    <article>
      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Deleniti quos exercitationem maxime officia, quas magnam nostrum quaerat nesciunt dignissimos. Ratione iure est reiciendis sed excepturi amet pariatur delectus soluta! Vel?
    </article>
  </div>
</main>